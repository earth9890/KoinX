...
import apiLinks from "../../API/API_Links";
...
const CryptoDetails = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-white p-4 rounded-lg">
      <h1 className="text-xl font-bold capitalize mb-4">{Object.keys(data)}</h1>

      {bitcoinPrice && <h2 className="text-2xl font-bold">${formated}</h2>}
      {bitcoinPriceInr && <h2 className="font-bold mb-6">${formatedinr}</h2>}
